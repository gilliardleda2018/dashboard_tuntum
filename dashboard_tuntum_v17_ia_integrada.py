...
st.caption("Este bloco usa a API da OpenAI para interpretar os dados filtrados do painel e gerar uma leitura executiva.")
...
if st.button("Gerar análise com IA"):
    ...
    with st.spinner("Gerando análise..."):
        try:
            ...
            st.session_state["analise_ia_tuntum"] = f"Erro ao gerar análise com IA: {e}"
