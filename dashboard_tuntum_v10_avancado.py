...
# TÍTULO E KPIs
# =========================================================
st.title("Dashboard Eleitoral Tuntum 2024 - Versão Avançada")
...
with r1:
    ...
    top_oportunidade = ordered.head(top_n)[[
        "localidade", "eleitores", "abstencao", "fernando", "tema",
        "competitividade", "indice_oportunidade", "lider"
    ]].copy()
    st.dataframe(
...
with r2:
    ...
    mais_disputadas = ordered.sort_values(
        ...
        "localidade", "fernando", "tema", "validos",
...
with r3:
    ...
    crescimento_fernando = crescimento_fernando[
        ...
        "localidade", "fernando", "tema", "gap_para_virada",
