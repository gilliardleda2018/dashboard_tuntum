...
st.dataframe(
    pontos_votacao.sort_values(sort_col if sort_col in pontos_votacao.columns else "indice_oportunidade", ascending=False)[[
        "ponto_votacao", "localidades_atendidas", "secoes", "secoes_lista",
...
show = show[[
    "localidade", "local_principal", "secoes", "secoes_lista", "eleitores", "comparecimento",
...
if mostrar_sem_coord:
    ...
    sem = base_filtrada[base_filtrada["lat"].isna() | base_filtrada["lon"].isna()][[
        "localidade", "local_principal", "secoes_lista", "eleitores", "fernando", "tema", "abstencao"
    ]].copy()
